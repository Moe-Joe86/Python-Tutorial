# Etappe 16: Bug-Jagd II - kein neues Feature, Code identisch zu et15.py (wie et8.py zu
# et7.py). Tick-Tabelle von Hand, Fahndungsliste (14 Punkte), Dreizeiler-Protokoll und
# Bisektionsuebung stehen in GELERNT.md und FEHLERTAGEBUCH.md.
#
